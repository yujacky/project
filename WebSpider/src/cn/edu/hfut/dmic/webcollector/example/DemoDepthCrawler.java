...
public class DemoDepthCrawler extends BreadthCrawler {
    ...
    public static void main(String[] args) throws Exception {
    	String dir = DemoDepthCrawler.class.getResource("/").toURI().getPath();
    	dir = dir.substring(0,dir.lastIndexOf("bin"))+"data";
    	System.out.println(dir);
    	
        DemoDepthCrawler crawler = new DemoDepthCrawler(dir, true);
